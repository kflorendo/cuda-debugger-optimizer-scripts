...
plt.ylabel('Time(s)')
plt.savefig("output/gridX", dpi='figure', format=None)
plt.clf()
...
plt.ylabel('Time(s)')
plt.savefig("output/gridY", dpi='figure', format=None)
plt.clf()
...
plt.ylabel('Time(s)')
plt.savefig("output/gridZ", dpi='figure', format=None)
plt.clf()
...
plt.ylabel('Time(s)')
plt.savefig("output/blockX", dpi='figure', format=None)
plt.clf()
...
plt.ylabel('Time(s)')
plt.savefig("output/blockY", dpi='figure', format=None)
plt.clf()
...
plt.ylabel('Time(s)')
plt.savefig("output/blockZ", dpi='figure', format=None)
plt.clf()
...
plt.savefig("output/all", dpi='figure', format=None)
